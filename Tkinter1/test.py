...
def ventana3():
    ...
    a=Radiobutton(win2, text="SISBEN A", variable=varopcion2a, value="A",  padx=10, pady=10)
    a.grid(row=8, column=1)
    b=Radiobutton(win2, text="SISBEN B", variable=varopcion2a, value="B",  padx=10, pady=10)
    b.grid(row=9, column=1)
    c=Radiobutton(win2, text="SISBEN C", variable=varopcion2a, value="C",  padx=10, pady=10)
    ...
    Label(win2, text="Tipo de sisben:").grid(row=7, column=0, sticky="e",pady=10)
...
if __name__=="__main__":
    ...
    boton3=tk.Button(fhframe,text=" Registrar  ",bg="#0071bc", fg="white", command=ventana3,width="20", height="1", font=('Arial', 20, "bold" )).pack(pady=7)
    boton4=tk.Button(fhframe,text="Buscar",bg="#0071bc", fg="white", command=ventana4,width="20", height="1", font=('Arial', 20, "bold" )).pack(pady=8)
    boton5=tk.Button(fhframe,text="Informacion",bg="#0071bc", fg="white", command=ventana5,width="20", height="1", font=('Arial', 20, "bold" )).pack(pady=9)
